...
<head>
  ...
  <title>View Subjects - <?php echo $instname ?> </title>
  <?php 
  ...
  if(isset($_GET['delid'])){
   ...
   $id=$_GET['delid'];
      ...
      $sql = "UPDATE subject SET `del` = '1' WHERE `id` =$id";
...
<?php if(!empty($_GET['id'])){ ?>
   ...
   $id=$_GET['id'];
      ...
      $rows =mysqli_query($con,"SELECT * FROM subject where id=$id ORDER BY name" ) or die(mysqli_error($con));
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Edit Subject Details</h4>
...
<div class="content-body">
  <section id="configuration">
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">View All Subjects of <?php echo $instname ?></h4>
            <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
            <div class="heading-elements">
              <ul class="list-inline mb-0">
                <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
  ...
  <table id="stdtable" class="table table-striped table-bordered zero-configuration">
    ...
    <tbody>
      ...
      $rows =mysqli_query($con,"SELECT * FROM subject WHERE del=0 ORDER BY id " ) or die(mysqli_error($con));
      $n=0;
